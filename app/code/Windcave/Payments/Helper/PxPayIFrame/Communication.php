...
class Communication extends AbstractHelper
{
    ...
    private function _buildPxPay2Request($requestData, $storeId = null)
    {
        ...
        $returnUrl = $this->_getUrl('pxpay2/pxpay2iframe/redirectback', ['_secure' => true]);
        $callbackUrl = $this->_getUrl('pxpay2/pxpay2iframe/notification', ['_secure' => true]);
        ...
        $requestObject->addChild("UrlFail", $returnUrl);
        $requestObject->addChild("UrlSuccess", $returnUrl);
        $requestObject->addChild("UrlCallback", $callbackUrl);
        ...
        // <EmailAddress>samplepxpayuser@windcave.com</EmailAddress>
