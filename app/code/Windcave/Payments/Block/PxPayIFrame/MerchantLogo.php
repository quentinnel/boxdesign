<?php
namespace Windcave\Payments\Block\PxPayIFrame;
...
class MerchantLogo extends \Magento\Framework\View\Element\Template
{
    ...
    /**
     *
     * @var \Windcave\Payments\Helper\Configuration\PxPayIFrame
     */
     ...
     * @param \Windcave\Payments\Helper\PxPayIFrame\Configuration $configuration
     * @param array                                              $data
     */
    public function __construct(
        \Magento\Framework\View\Element\Template\Context $context,
        \Magento\MediaStorage\Helper\File\Storage\Database $fileStorageHelper,
        \Windcave\Payments\Helper\PxPayIFrame\Configuration $configuration,
        array $data = []
    ) {
    ...
    {
        $this->_logger->info(__METHOD__);
        $folderName = \Windcave\Payments\Model\Config\Backend\MerchantLogo::UPLOAD_DIR;
