...
class Payment extends \Magento\Payment\Model\Method\AbstractMethod
{
    ...
    /**
     *
     * @var \Windcave\Payments\Model\PxPayIFrame\PaymentHelper
     */
    private $_paymentHelper;

    /**
     *
     * @var \Windcave\Payments\Model\Api\ApiPxPayIFrameHelper
     */
    ...
    const PXPAY_CODE = "windcave_pxpay2_iframe";
    ...
    public function __construct(
        ...
        \Magento\Sales\Api\TransactionRepositoryInterface $txnRepository,
        ...
        $this->_apiPxPayHelper = $this->_objectManager->get("\Windcave\Payments\Model\Api\ApiPxPayIFrameHelper");
        
        /** @var \Windcave\Payments\Helper\PxPayIFrame\Configuration $configuration*/
        $configuration = $this->_objectManager->get("\Windcave\Payments\Helper\PxPayIFrame\Configuration");
        /** @var \Windcave\Payments\Helper\PxPayIFrame\Communication $communication*/
        $communication = $this->_objectManager->get("\Windcave\Payments\Helper\PxPayIFrame\Communication");
        $this->_paymentHelper = $this->_objectManager->create("\Windcave\Payments\Model\PxPayIFrame\PaymentHelper");
        $this->_paymentHelper->init($configuration, $communication, $txnBuilder, $messageManager, $txnRepository, $registry);
