...
abstract class CommonAction extends \Magento\Framework\App\Action\Action
{
    ...
    public function __construct(
        ...
        $this->_communication = $this->_objectManager->get("\Windcave\Payments\Helper\Communication");
        $this->_configuration = $this->_objectManager->get("\Windcave\Payments\Helper\Configuration");
    ...
    private function _saveOrderPaymentResult(
        $pxpayUserId,
        $token,
        \Magento\Sales\Model\Order $order,
